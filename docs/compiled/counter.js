...
Object.defineProperty(exports, "__esModule", { value: true });
const DeStagnate = __importStar(__webpack_require__(1));
class Counter extends DeStagnate.Component {
    constructor(parent) {
        ...
        this.render = () => DeStagnate.createElement("div", null,
            DeStagnate.createElement("p", null, "Seconds:"),
            DeStagnate.createElement("p", null, this.state.count));
        this.state = {
            count: 0,
        };
    }
...
//# sourceMappingURL=data:application/json;base64,
