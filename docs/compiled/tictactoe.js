(function () {
    ...
    class TicTacToe extends DeStagnate {
      constructor() {
        super(...arguments);
        this._squares = [[new Square(), new Square(), new Square()], [new Square(), new Square(), new Square()], [new Square(), new Square(), new Square()]];
        ...
        this._checkForWinner = () => {
          ...
          const diagonals = [[this._squares[0][0].getState.clicked, this._squares[1][1].getState.clicked, this._squares[2][2].getState.clicked], [this._squares[0][2].getState.clicked, this._squares[1][1].getState.clicked, this._squares[2][0].getState.clicked]];
        ...
        this.render = () => [0, 1, 2] // Create 3 rows
        .map(val => createElement$1("div", {
          class: "row"
        }, // Create 3 columns
        [0, 1, 2].map(val2 => createElement$1("div", {
          class: "col-4",
          onClick: () => {
            // Current square
            const square = this._squares[val][val2]; // Check if square isn't already clicked
    ...
    class Square extends DeStagnate {
      constructor() {
        super();

        this.render = () => createElement$1("div", {
