...
// Current player
let currentPlayer = "x";
class TicTacToe extends destagnate_1.default {
    constructor() {
        super(...arguments);
        this._squares = [
        ...
        this.render = () => [0, 1, 2]
            // Create 3 rows
            .map((val) => destagnate_1.createElement("div", { class: "row" },
        // Create 3 columns
        [0, 1, 2].map((val2) => destagnate_1.createElement("div", {
            class: "col-4",
            onClick: () => {
                // Current square
                ...
                if ((square === null || square === void 0 ? void 0 : square.getState.clicked) === "") {
                    square === null || square === void 0 ? void 0 : square.setState({ clicked: currentPlayer });
                }
...
class Square extends destagnate_1.default {
    constructor() {
        super();
        this.render = () => destagnate_1.createElement("div", { class: "tictactoe-square", }, this.state.clicked);
        this.state = {
            clicked: "",
        };
    }
...
const mountTicTacToe = () => {
    if (tictactoeParent) {
        const tictactoe = new TicTacToe(tictactoeParent), resetBtn = document.getElementById("nested-reset-btn");
        if (resetBtn) {
...
mountTicTacToe();
//# sourceMappingURL=data:application/json;base64,
