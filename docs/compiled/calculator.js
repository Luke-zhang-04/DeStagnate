...
class Calculator extends destagnate_1.default {
    constructor(parent) {
        super(parent);
        /**
         ...
         */
        this._calcButton = (text, append) => destagnate_1.createElement("div", {
         ...
         */
        this._evalCalc = () => eval(this.state.calculation);
        /* eslint-disable no-eval */
        /**
         ...
         */
        this._numBtns = [
            destagnate_1.default.createElement("div", { class: "calc-btns row" }, ["7", "8", "9", ["x", "*"]].map((val) => (this._calcButton(val instanceof Array ? val[0] : val, val instanceof Array ? val[1] : val)))),
            destagnate_1.default.createElement("div", { class: "calc-btns row" }, ["4", "5", "6", "-"].map((val) => (this._calcButton(val instanceof Array ? val[0] : val, val instanceof Array ? val[1] : val)))),
            destagnate_1.default.createElement("div", { class: "calc-btns row" }, ["1", "2", "3", "+"].map((val) => (this._calcButton(val instanceof Array ? val[0] : val, val instanceof Array ? val[1] : val)))),
        ];
        /**
         * Calculator Display
         * @returns {HTMLElement} display
         */
        this._calcDisplay = () => destagnate_1.createElement("div", { class: "calc-display" }, this.state.calculation);
        this.render = () => (destagnate_1.default.createElement("div", null,
            this._calcDisplay(),
            destagnate_1.default.createElement("div", { class: "calc-btns row" },
                destagnate_1.default.createElement("div", { class: "col-3 calc-btn clear", onClick: () => this.setState({ calculation: "" }) }, "C"),
                destagnate_1.createElement("div", {
                    class: "col-3 calc-btn",
            ...
            destagnate_1.createElement("div", { class: "calc-btns row" }, [
                this._calcButton("0"),
                this._calcButton("."),
                destagnate_1.createElement("div", {
...
//# sourceMappingURL=data:application/json;base64,
