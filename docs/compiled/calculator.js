 ...
 */Object.defineProperty(e,"__esModule",{value:!0}),e.createElementNS=void 0;const i=n(4);e.createElementNS=(t,e,n,o,...s)=>{const r=document.createElementNS(t,e);i.bindProps(r,n,!0);let a=o;return o&&s&&(a="object"==typeof o&&o instanceof Array?[...i.unpackChildren(o),...i.unpackChildren(s)]:[o,...i.unpackChildren(s)]),i.bindChildren(r,a),r},e.default=e.createElementNS},function(module,exports,__webpack_require__){"use strict";var __extends=this&&this.__extends||(extendStatics=function(t,e){return(extendStatics=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])})(t,e)},function(t,e){function n(){this.constructor=t}extendStatics(t,e),t.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)}),extendStatics,__createBinding=this&&this.__createBinding||(Object.create?function(t,e,n,i){void 0===i&&(i=n),Object.defineProperty(t,i,{enumerable:!0,get:function(){return e[n]}})}:function(t,e,n,i){void 0===i&&(i=n),t[i]=e[n]}),__setModuleDefault=this&&this.__setModuleDefault||(Object.create?function(t,e){Object.defineProperty(t,"default",{enumerable:!0,value:e})}:function(t,e){t.default=e}),__importStar=this&&this.__importStar||function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)"default"!==n&&Object.prototype.hasOwnProperty.call(t,n)&&__createBinding(e,t,n);return __setModuleDefault(e,t),e};Object.defineProperty(exports,"__esModule",{value:!0});var destagnate_1=__importStar(__webpack_require__(0)),Calculator=function(_super){function Calculator(parent){var _this=_super.call(this,parent)||this;return _this._appendState=function(t,e){return{calculation:_this.state.calculation+(e||t)}},_this._calcButton=function(t,e){return destagnate_1.createElement("div",{class:"col-3 calc-btn",onClick:function(){return _this.setState(_this._appendState(t,e))}},t)},_this._evalCalc=function(){return eval(_this.state.calculation)},_this._numBtns=[destagnate_1.default.createElement("div",{class:"calc-btns row"},["7","8","9",["x","*"]].map((function(t){return _this._calcButton(t instanceof Array?t[0]:t,t instanceof Array?t[1]:t)}))),destagnate_1.default.createElement("div",{class:"calc-btns row"},["4","5","6","-"].map((function(t){return _this._calcButton(t instanceof Array?t[0]:t,t instanceof Array?t[1]:t)}))),destagnate_1.default.createElement("div",{class:"calc-btns row"},["1","2","3","+"].map((function(t){return _this._calcButton(t instanceof Array?t[0]:t,t instanceof Array?t[1]:t)})))],_this._calcDisplay=function(){return destagnate_1.createElement("div",{class:"calc-display"},_this.state.calculation)},_this.render=function(){return destagnate_1.default.createElement("div",null,_this._calcDisplay(),destagnate_1.default.createElement("div",{class:"calc-btns row"},destagnate_1.default.createElement("div",{class:"col-3 calc-btn clear",onClick:function(){return _this.setState({calculation:""})}},"C"),destagnate_1.createElement("div",{class:"col-3 calc-btn",onClick:function(){return _this.setState({calculation:_this.state.calculation.slice(0,_this.state.calculation.length-1)})}},"←"),_this._calcButton("%"),_this._calcButton("÷","/")),_this._numBtns.map((function(t){return t})),destagnate_1.createElement("div",{class:"calc-btns row"},[_this._calcButton("0"),_this._calcButton("."),destagnate_1.createElement("div",{class:"col-6 calc-btn equals",onClick:function(){return _this.setState({calculation:_this._evalCalc()})}},"=")]))},_this.state={calculation:""},_this}return __extends(Calculator,_super),Calculator}(destagnate_1.default),calculator=new Calculator(document.querySelector("#calculator"));calculator.mount()},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
