(function () {
    ...
    class Calculator extends DeStagnate {
      constructor(parent) {
        ...
        this._numBtns = [DeStagnate.createElement("div", {
          class: "calc-btns row"
        }, ["7", "8", "9", ["x", "*"]].map(val => DeStagnate.createElement(this._calcButton, {
          text: val instanceof Array ? val[0] : val,
          append: val instanceof Array ? val[1] : val
        }))), DeStagnate.createElement("div", {
          class: "calc-btns row"
        }, ["4", "5", "6", "-"].map(val => DeStagnate.createElement(this._calcButton, {
          text: val instanceof Array ? val[0] : val,
          append: val instanceof Array ? val[1] : val
        }))), DeStagnate.createElement("div", {
          class: "calc-btns row"
        }, ["1", "2", "3", "+"].map(val => DeStagnate.createElement(this._calcButton, {
          text: val instanceof Array ? val[0] : val,
          append: val instanceof Array ? val[1] : val
        })))];
        /**
        ...
        this._calcDisplay = () => DeStagnate.createElement("div", {
          class: "calc-display"
        }, this.state.calculation);

        this.render = () => DeStagnate.createElement("div", null, DeStagnate.createElement(this._calcDisplay, null), DeStagnate.createElement("div", {
          class: "calc-btns row"
        }, DeStagnate.createElement("div", {
        ...
        }, "C"), DeStagnate.createElement("div", {
          class: "col-3 calc-btn",
          onClick: () => this.setState({
            calculation: this.state.calculation.slice(0, this.state.calculation.length - 1)
          })
        }, "\u2190"), DeStagnate.createElement(this._calcButton, {
          text: "%"
        }), DeStagnate.createElement(this._calcButton, {
          text: "\u00f7",
          append: "/"
        })), this._numBtns.map(btn => btn), DeStagnate.createElement("div", {
          class: "calc-btns row"
        }, DeStagnate.createElement(this._calcButton, {
          text: "0"
        }), DeStagnate.createElement(this._calcButton, {
