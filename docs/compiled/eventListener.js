 ...
 */Object.defineProperty(e,"__esModule",{value:!0}),e.createElement=void 0;const i=n(5);function o(t,e,n,...o){let r=n;if(n&&o&&(r=n instanceof Array?[...i.unpackChildren(n),...i.unpackChildren(o)]:[n,...i.unpackChildren(o)]),"string"==typeof t){const n=document.createElement(t);return i.bindProps(n,e),i.bindChildren(n,r),n}return"function"==typeof t?t(e,r):Error("tagNameOrComponent is of invalid type.")}e.createElement=o,e.default=o},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
 ...
 * @preserve
 */Object.defineProperty(e,"__esModule",{value:!0}),e.Component=e.createRef=e.createElementNS=e.createElement=void 0;const i=n(0),o=n(4),r=n(1),s=n(2);var a=n(1);Object.defineProperty(e,"createElement",{enumerable:!0,get:function(){return a.createElement}});var c=n(2);Object.defineProperty(e,"createElementNS",{enumerable:!0,get:function(){return c.createElementNS}});var u=n(0);Object.defineProperty(e,"createRef",{enumerable:!0,get:function(){return u.createRef}});var d=n(4);Object.defineProperty(e,"Component",{enumerable:!0,get:function(){return d.Component}}),e.default={createElement:r.createElement,createElementNS:s.createElementNS,createRef:i.createRef,Component:o.Component}},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
 ...
 */var i=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0}),e.bindChildren=e.unpackChildren=e.bindProps=void 0;const o=n(3),r=i(n(6));e.bindProps=(t,e,n=!1)=>{if(e)for(const[i,o]of Object.entries(e))"string"==typeof o||"number"==typeof o?"innerHTML"===i?t.innerHTML=o.toString():n?t.setAttributeNS(null,i,o.toString()):t.setAttribute(i,o.toString()):"on"===i.slice(0,2)?"function"==typeof o&&t.addEventListener(i.slice(2).toLowerCase(),o):"ref"===i&&"object"==typeof o&&"current"in o?o.current=t:void 0!==o&&console.warn(`WARN: Code 7. See ${r.default}. Params: ${typeof o}, ${i}`)},e.unpackChildren=t=>{const n=[];for(const i of t)"object"==typeof i&&i instanceof Array?n.push(...e.unpackChildren(i)):n.push(i);return n},e.bindChildren=(t,n)=>{if(null!=n)if(n instanceof Array)for(const i of n)e.bindChildren(t,i);else if("string"==typeof n||"number"==typeof n)t.innerText=n.toString();else if(n instanceof o.Component){if(!n.didMount&&t instanceof window.HTMLElement)return void n.mount(t);if(!(t instanceof window.HTMLElement))throw new Error("ERROR: code 8. See "+r.default);n.parent!==t&&(n.parent=t),n.forceUpdate()}else t.appendChild(n)}},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
 ...
 * @version 2.0.0
 * @file share functions and types for createElement and it's variants
 */Object.defineProperty(e,"__esModule",{value:!0}),e.url=void 0,e.url="https://luke-zhang-04.github.io/DeStagnate/error-codes",e.default=e.url},function(t,e,n){"use strict";var i=this&&this.__createBinding||(Object.create?function(t,e,n,i){void 0===i&&(i=n),Object.defineProperty(t,i,{enumerable:!0,get:function(){return e[n]}})}:function(t,e,n,i){void 0===i&&(i=n),t[i]=e[n]}),o=this&&this.__setModuleDefault||(Object.create?function(t,e){Object.defineProperty(t,"default",{enumerable:!0,value:e})}:function(t,e){t.default=e}),r=this&&this.__importStar||function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)"default"!==n&&Object.prototype.hasOwnProperty.call(t,n)&&i(e,t,n);return o(e,t),e};Object.defineProperty(e,"__esModule",{value:!0});const s=r(n(3));class a extends s.default.Component{constructor(t){super(t),this.onClick=()=>{const t=["primary","secondary","success","info","warning","danger","light","dark"].filter(t=>this.state.color!==t);this.setState({color:t[Math.floor(Math.random()*t.length)]})},this.render=()=>s.createElement("button",{class:"btn btn-"+this.state.color,onClick:()=>alert("Clicked!")},"Click Me!"),this.state={color:"primary"}}}new a(document.querySelector("#elistener")).mount()},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
 ...
 * @exports Events
 * @package
 */var i=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});const o=i(n(9));class r extends o.default{constructor(){super(...arguments),this.onFocus=void 0,this.onBlur=void 0,this.onFocusIn=void 0,this.onFocusOut=void 0,this.onAnimationStart=void 0,this.onAnimationCancel=void 0,this.onAnimationEnd=void 0,this.onAnimationIteration=void 0,this.onTransitionStart=void 0,this.onTransitionCancel=void 0,this.onTransitionEnd=void 0,this.onTransitionRun=void 0,this.onAuxClick=void 0,this.onClick=void 0,this.onDblClick=void 0,this.onMouseDown=void 0,this.onMouseEnter=void 0,this.onMouseLeave=void 0,this.onMouseMove=void 0,this.onMouseOver=void 0,this.onMouseOut=void 0,this.onMouseUp=void 0,this.bindEventListeners=t=>{this._eventListener(t.addEventListener)},this.unbindEventListeners=t=>{this._eventListener(t.removeEventListener)},this._eventListener=t=>{this.onFocus&&t("focus",this.onFocus),this.onBlur&&t("blur",this.onBlur),this.onFocusIn&&t("focusin",this.onFocusIn),this.onFocusOut&&t("focusout",this.onFocusOut),this.onAnimationStart&&t("animationstart",this.onAnimationStart),this.onAnimationEnd&&t("animationend",this.onAnimationEnd),this.onAnimationCancel&&t("animationcancel",this.onAnimationCancel),this.onAnimationIteration&&t("animationiteration",this.onAnimationIteration),this.onTransitionStart&&t("transitionstart",this.onTransitionStart),this.onTransitionEnd&&t("transitionend",this.onTransitionEnd),this.onTransitionCancel&&t("transitioncancel",this.onTransitionCancel),this.onTransitionRun&&t("transitionrun",this.onTransitionRun),this.onAuxClick&&t("auxclick",this.onAuxClick),this.onDblClick&&t("dblclick",this.onDblClick),this.onClick&&t("click",this.onClick),this.onDblClick&&t("dblclick",this.onDblClick),this.onMouseDown&&t("mousedown",this.onMouseDown),this.onMouseEnter&&t("mouseenter",this.onMouseEnter),this.onMouseLeave&&t("mouseleave",this.onMouseLeave),this.onMouseMove&&t("mousemove",this.onMouseMove),this.onMouseOver&&t("mouseover",this.onMouseOver),this.onMouseOut&&t("mouseout",this.onMouseOut),this.onMouseUp&&t("mouseup",this.onMouseUp)}}}e.default=r},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
 ...
 * @package
 */var i=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});const o=i(n(1)),r=i(n(2)),s=i(n(0));class a{constructor(){this.createElement=o.default,this.createElementNS=r.default,this.createRef=s.default,this.componentDidCatch=t=>console.error(t),this.componentDidMount=()=>{},this.componentDidUpdate=()=>{},this.componentDidWarn=t=>console.warn(t),this.componentWillMount=()=>{},this.componentWillUnmount=()=>{},this.componentWillUpdate=()=>{},this.shouldComponentUpdate=()=>!0,this.render=()=>null}}e.default=a,a.createElement=o.default,a.createElementNS=r.default,a.createRef=s.default}])}));