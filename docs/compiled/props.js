...
class PropsDemo extends destagnate_1.default {
    constructor() {
        super(...arguments);
        this.render = () => this.props.colors.map((color) => (destagnate_1.createElement("button", { class: `btn btn-${color}` }, `${color} button`)));
    }
}
const propsDemo = new PropsDemo(document.querySelector("#props"), { colors: [
        "primary",
        "secondary",
        "success",
        "info",
...
//# sourceMappingURL=data:application/json;base64,
