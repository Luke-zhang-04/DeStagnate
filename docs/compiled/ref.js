 ...
 * @version 2.0.0
 * @file share functions and types for createElement and it's variants
 */Object.defineProperty(e,"__esModule",{value:!0}),e.url=void 0,e.url="https://luke-zhang-04.github.io/DeStagnate/error-codes",e.default=e.url},function(t,e,n){"use strict";var i=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});const o=i(n(3));class s extends o.default.Component{constructor(){super(...arguments),this.render=()=>o.default.createElement("form",null,o.default.createElement("input",{onInput:t=>{console.log(t)}}))}}const r=document.getElementById("ref");if(r){new s(r).mount()}},function(t,e,n){"use strict";
/**
 * DeStagnate
 * A simple, ReactJS inspired library to create dynamic components within static sites easier
 * @copyright Copyright (C) 2020 Luke Zhang
