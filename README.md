...
# Latest
curl -L https://unpkg.com/destagnate@2.0.0/dist/deStagnate.bundle.min.js > deStagnate.bundle.min.js
wget https://unpkg.com/destagnate@2.0.0/dist/deStagnate.bundle.min.js
```
...
<!-- Latest -->
<script src="https://unpkg.com/destagnate@2.0.0/dist/deStagnate.bundle.min.js"></script>
```
