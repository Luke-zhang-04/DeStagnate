...
var DeStagnate = function (modules) {
  ...
  var component_1 = __importDefault(__webpack_require__(2));

  var createDSComponent_1 = __importDefault(__webpack_require__(6));

  var createElement_1 = __importDefault(__webpack_require__(7));

  var createElementNS_1 = __importDefault(__webpack_require__(10));
  /**
   ...
   * @abstract
   */
  var DeStagnate = function (_events_1$default) {
    ...
    _createClass(DeStagnate, [{
      ...
      set: function set(obj) {
        if (this._didSetInitialState && this._strict) {
          this.componentDidCatch(new Error("ERROR: code 2. See ".concat(_url_1["default"], ".")));
  ...
  var Events = function (_base_1$default) {
    ...
    if (props) {
      for (var _i3 = 0, _Object$entries = Object.entries(props); _i3 < _Object$entries.length; _i3++) {
        ...
        if (typeof val === "string" || typeof val === "number") {
          ...
          console.warn("WARN: Code 7. See ".concat(_url_1["default"], ". Params: ").concat(_typeof(val), ", ").concat(key));
        }
      }
    }
  };
